...
<head>
    ...
    if (file_exists("src/routes/$request_route/css.php")) {
        include_once("src/routes/$request_route/css.php");
    }
...
<body class="hold-transition skin-blue sidebar-mini page-<?= $request_route ?> <?= $_SESSION['sidebar-collapse'] ?>">
