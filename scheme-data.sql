...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  CONSTRAINT `FKmenu_page_cat_id` FOREIGN KEY (`pagecat_id`) REFERENCES `pagecats` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FKmenu_page_id` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FKmenu_page_tag_id` FOREIGN KEY (`pagetag_id`) REFERENCES `pagetags` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FKmenu_page_tag_type_id` FOREIGN KEY (`pagetagtype_id`) REFERENCES `pagetagtypes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FKmenu_page_type_id` FOREIGN KEY (`pagetype_id`) REFERENCES `pagetypes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- Dumping structure for table sablon-fs.pagecats
...
-- Dumping structure for table sablon-fs.pagecat_lang
CREATE TABLE IF NOT EXISTS `pagecat_lang` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `data_id` int(10) unsigned NOT NULL,
  `lang_id` int(10) unsigned NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `FKpagecatlang_data_id` FOREIGN KEY (`data_id`) REFERENCES `pagecats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  CONSTRAINT `FKpage_cat_id` FOREIGN KEY (`cat_id`) REFERENCES `pagecats` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FKpage_type_id` FOREIGN KEY (`type_id`) REFERENCES `pagetypes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- Dumping structure for table sablon-fs.pagetags
CREATE TABLE IF NOT EXISTS `pagetags` (
  ...
  CONSTRAINT `FKpagetag_type_id` FOREIGN KEY (`type_id`) REFERENCES `pagetagtypes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dumping structure for table sablon-fs.pagetagtypes
CREATE TABLE IF NOT EXISTS `pagetagtypes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `is_active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `deleted` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- Dumping structure for table sablon-fs.pagetag_lang
CREATE TABLE IF NOT EXISTS `pagetag_lang` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `data_id` int(10) unsigned NOT NULL,
  `lang_id` int(10) unsigned NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `FKpagetaglang_data_id` FOREIGN KEY (`data_id`) REFERENCES `pagetags` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dumping structure for table sablon-fs.pagetypes
...
CREATE TABLE IF NOT EXISTS `page_pagetags` (
  ...
  CONSTRAINT `FKpagepagetags_tag_id` FOREIGN KEY (`tag_id`) REFERENCES `pagetags` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
