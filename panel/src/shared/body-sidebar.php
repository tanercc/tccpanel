...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php if (has_user_permission(['page'])) : ?>
                <li class="treeview <?= is_treemenu_active('page') ?>">
                    <a href="#"><i class="fa fa-file-text-o"></i> <span><?= lang('pages') ?></span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="<?= is_menu_active('page') ?>"><a href="<?= set_href('page') ?>"><i class="fa fa-table"></i> <?= lang('list') ?></a></li>
                        <li class="<?= is_menu_active('pagetype') ?>"><a href="<?= set_href('pagetype') ?>"><i class="fa fa-files-o"></i> <?= lang('pagetypes') ?></a></li>
                        <li class="<?= is_menu_active('pagecat') ?>"><a href="<?= set_href('pagecat') ?>"><i class="fa fa-sitemap"></i> <?= lang('pagecats') ?></a></li>
                        <li class="<?= is_menu_active('pagetagtype') ?>"><a href="<?= set_href('pagetagtype') ?>"><i class="fa fa-tags"></i> <?= lang('pagetagtypes') ?></a></li>
                        <li class="<?= is_menu_active('pagetag') ?>"><a href="<?= set_href('pagetag') ?>"><i class="fa fa-tag"></i> <?= lang('pagetags') ?></a></li>
                    </ul>
                </li>
            <?php endif ?>
