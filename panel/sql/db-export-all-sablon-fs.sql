...
-- Dumping data for table sablon-fs.logs: ~16 rows (approximately)
...
INSERT INTO `logs` (`id`, `task`, `comment`, `task_at`, `ip_no`, `user_id`, `created_at`, `updated_at`) VALUES
	...
	(7, 'POST pagetype/delete', 'UPDATE `page_types` SET `deleted`=1 WHERE `id`=3;', '2019-07-09 22:23:31', '127.0.0.1', 1, '2019-07-09 22:23:31', NULL),
	(8, 'POST pagetype/delete', 'UPDATE `page_types` SET `deleted`=1 WHERE `id`=3;', '2019-07-09 22:32:45', '127.0.0.1', 1, '2019-07-09 22:32:45', NULL),
	(9, 'POST pagetype/delete', 'UPDATE `page_types` SET `deleted`=1 WHERE `id`=2;', '2019-07-09 22:33:11', '127.0.0.1', 1, '2019-07-09 22:33:11', NULL),
	(10, 'POST pagetype/delete', 'UPDATE `page_types` SET `deleted`=1 WHERE `id`=1;', '2019-07-09 23:23:44', '127.0.0.1', 1, '2019-07-09 23:23:44', NULL),
	(11, 'POST pagetype/delete', 'UPDATE `page_types` SET `deleted`=1 WHERE `id`=1;', '2019-07-09 23:27:42', '127.0.0.1', 1, '2019-07-09 23:27:42', NULL),
	(12, 'POST page/delete', 'UPDATE `pages` SET `deleted`=1 WHERE `id`=1;', '2019-07-09 23:37:54', '127.0.0.1', 1, '2019-07-09 23:37:54', NULL),
	(13, 'POST menutype/index', 'UPDATE `page_types` SET `name`=\'Sayfa\',`slug`=\'sayfa\',`is_active`=\'1\' WHERE `id`=1;', '2019-07-11 14:22:04', '127.0.0.1', 1, '2019-07-11 14:22:04', NULL),
	(14, 'POST menutype/index', 'UPDATE `menu_types` SET `name`=\'Ana Menü\',`slug`=\'anamenu\',`is_active`=\'1\' WHERE `id`=1;', '2019-07-11 14:24:35', '127.0.0.1', 1, '2019-07-11 14:24:35', NULL),
	(15, 'POST menutype/index', 'UPDATE `menu_types` SET `name`=\'Ana Menü\',`slug`=\'anamenux\',`is_active`=\'1\' WHERE `id`=1;', '2019-07-11 14:24:40', '127.0.0.1', 1, '2019-07-11 14:24:40', NULL),
	(16, 'POST menutype/index', 'UPDATE `menu_types` SET `name`=\'Ana Menü\',`slug`=\'anamenu\',`is_active`=\'1\' WHERE `id`=1;', '2019-07-11 14:24:43', '127.0.0.1', 1, '2019-07-11 14:24:43', NULL);
...
INSERT INTO `menu_types` (`id`, `name`, `slug`, `is_active`, `deleted`, `order`, `created_at`, `updated_at`) VALUES
	(1, 'Ana Menü', 'anamenu', 1, 0, 50, '2019-06-22 18:50:35', '2019-07-11 14:24:43');
...
-- Dumping data for table sablon-fs.pages: ~2 rows (approximately)
...
INSERT INTO `pages` (`id`, `name`, `slug`, `info`, `content`, `image`, `video`, `file`, `link`, `writer`, `write_at`, `coordinate`, `include`, `type_id`, `cat_id`, `upper_id`, `is_active`, `deleted`, `order`, `column_1`, `column_2`, `column_3`, `column_4`, `column_5`, `column_6`, `column_7`, `column_8`, `column_9`, `created_at`, `updated_at`) VALUES
	(1, 'Test', 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-07-09 16:31:11', '2019-07-09 23:38:18'),
	(2, 'Test2', 'test2', '', '', '', '', '', '', '', NULL, 'test', '', 1, 3, 1, 1, 0, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-07-09 16:40:37', '2019-07-11 14:17:17');
...
-- Dumping data for table sablon-fs.page_cats: ~11 rows (approximately)
/*!40000 ALTER TABLE `page_cats` DISABLE KEYS */;
INSERT INTO `page_cats` (`id`, `name`, `slug`, `image`, `file`, `link`, `upper_id`, `is_active`, `deleted`, `order`, `created_at`, `updated_at`) VALUES
	(1, 'cat1', 'cat1', NULL, NULL, NULL, NULL, 1, 0, 50, '2019-06-29 20:06:05', NULL),
	(2, 'cat11', 'cat11', NULL, NULL, NULL, 1, 1, 0, 50, '2019-06-29 20:06:16', NULL),
	(3, 'cat12', 'cat12', NULL, NULL, NULL, 1, 1, 0, 50, '2019-06-29 20:06:26', NULL),
	(4, 'cat2', 'cat2', NULL, NULL, NULL, NULL, 1, 0, 50, '2019-06-29 20:06:35', NULL),
	(5, 'cat3', 'cat3', NULL, NULL, NULL, NULL, 1, 0, 50, '2019-06-29 20:06:59', NULL),
	(6, 'cat31', 'cat31', NULL, NULL, NULL, 3, 1, 0, 50, '2019-06-29 20:07:14', NULL),
	(7, 'cat32', 'cat32', NULL, NULL, NULL, 3, 1, 0, 50, '2019-06-29 20:07:24', NULL),
	(8, 'cat321', 'cat321', NULL, NULL, NULL, 7, 1, 0, 50, '2019-06-29 20:07:42', NULL),
	(9, 'cat322', 'cat322', NULL, NULL, NULL, 7, 1, 0, 50, '2019-06-29 20:07:52', NULL),
	(10, 'cat323', 'cat323', NULL, NULL, NULL, 5, 1, 0, 50, '2019-06-29 20:08:02', '2019-07-11 15:11:00'),
	(11, 'cat4', 'cat4', NULL, NULL, NULL, NULL, 1, 0, 50, '2019-06-29 20:08:11', NULL),
	(12, 'cat5', 'cat5', NULL, NULL, NULL, NULL, 1, 0, 50, '2019-06-29 20:08:17', NULL);
...
-- Dumping data for table sablon-fs.page_types: ~2 rows (approximately)
...
INSERT INTO `page_types` (`id`, `name`, `slug`, `is_active`, `deleted`, `order`, `created_at`, `updated_at`) VALUES
	(1, 'Sayfa', 'sayfa', 1, 0, 50, '2019-06-24 14:16:00', '2019-07-10 00:46:02'),
	(2, 'Haber', 'haber', 1, 0, 50, '2019-06-24 14:16:08', '2019-07-09 23:24:41'),
	(3, 'Duyuru', 'duyuru', 1, 0, 50, '2019-06-24 14:16:21', '2019-07-09 23:24:45');
...
CREATE TABLE IF NOT EXISTS `sliders` (
  ...
  PRIMARY KEY (`id`),
  KEY `iproducttag_type_id` (`type_id`),
  CONSTRAINT `FKslider_type_id` FOREIGN KEY (`type_id`) REFERENCES `slider_types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dumping structure for table sablon-fs.slider_types
CREATE TABLE IF NOT EXISTS `slider_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `is_active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `deleted` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- Dumping data for table sablon-fs.slider_types: ~0 rows (approximately)
/*!40000 ALTER TABLE `slider_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `slider_types` ENABLE KEYS */;
...
-- Dumping data for table sablon-fs.variables: ~4 rows (approximately)
