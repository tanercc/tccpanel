...
// echo '<br>$request_page ';print_r($request_page);
...
if ($request_ajax) {
    ...
    include_once("src/routes/$request_page/$request_func.php");
    exit;
}
...
if (in_array($request_page, ['login'])) {
    // if method exist
    include_once("src/routes/$request_page/$request_func.php");
} else { 
    // <body>
    ...
    file_exists("src/routes/$request_page/$request_func-$request_method.php") AND include("src/routes/$request_page/$request_func-$request_method.php");
